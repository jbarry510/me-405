...
The brake method sets P\-W\-M controlled braking for motor. It does this by enabling the brake to G\-N\-D operating mode of the H-\/bridge chip.
...
The set\-\_\-power method allows the user to set the power supplied to the motor on a scale of -\/255 to 255 where the positive values turn the motor clockwise and negative values turn the motor counterclockwise.
