...
This file contains the \hyperlink{main_8cpp_a840291bc02cba5474a4cb46a9b9566fe}{main()} code for a program which runs the M\-E405 board for M\-E405 lab 1. This program currently uses an A/\-D converter to convert an analog signal into an L\-E\-D brightness via pulse width modulation.
