...
\begin{DoxyCompactList}\small\item\em This class will enable the H-\/bridge motor driver chips on the M\-E 405 board. \end{DoxyCompactList}\end{DoxyCompactItemize}
